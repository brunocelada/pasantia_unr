    ...
    if X_train_plot_data.shape[1] == 0 and model_type not in ["gam", "gpr"]: 
        ...
        if len(train_sizes_abs) == 0:
            ...
            try:
                ...
                else: print(f"Advertencia: Todas las puntuaciones de CV para {score_display_name} con {cv_method_label} son NaN. La línea de puntuación de CV no se trazó.")
                ...
                plt.text(0.5, 0.5, f"No se pudo generar la curva de aprendizaje {cv_method_label}: {e}", ha='center', va='center', wrap=True)
...
def main():
    ...
    parser.add_argument("--reduction", required=True, choices=["none", "pca", "efa", "plsr", "lasso", "rfe", "sparsepca", "mihr"], help="Tipo de reducción de dimensionalidad")
    ...
    # Definir X_train_pred_input antes de usarlo
    ...
    # Guardar resultados del conjunto de validación
    ...
    # Guardar resultados del conjunto de entrenamiento
