...
TRAINING_FILE = "training_set_sigman_cinchona.xlsx"

# VALIDATION_FILE = "validation_set.xlsx"
VALIDATION_FILE = "validation_set_sigman_cinchona.xlsx"

# Script a ejecutar, asegúrate de que sea el correcto (predictor.py)
PREDICTOR_SCRIPT_NAME = "predictor_V6.py" 
...
REDUCTION_OPTIONS = ["pca", "efa", "plsr", "lasso", "rfe", "sparsepca", "mihr", "none"]
MODEL_OPTIONS = ["mlr", "svm", "dt", "rf", "xgb", "knn", "ann", "gam", "gpr", "lgbm", "catb"]
